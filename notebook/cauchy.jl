...
# ╔═╡ 7e3b1dd7-dfc7-48b8-9c0d-9d71d8d3ea62
begin
	local T, Y = cauchy(midpoint!, linear, 0.5, 10.0, ones(1))
	local _, Y₂ = cauchy(implicit!, linear, 0.5, 10.0, ones(1))
	local fig = plot()
	scatter!(fig, T, first.(Y), label = "PM")
	scatter!(fig, T, first.(Y₂), label = "EI")
...
# ╔═╡ d2f5d13a-cd95-42e4-b6b8-d60e4057f93a
begin
